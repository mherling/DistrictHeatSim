...
from heat_generators import heat_generator_classes, Solarthermie_optimierung
...
def test_solar_thermal():
    ...
    Wärmemenge, Wärmeleistung_Solarthermie_L, Speicherladung_L, Speicherfüllstand_L = Solarthermie_optimierung.Berechnung_STA(solarThermal.bruttofläche_STA, solarThermal.vs, solarThermal.Typ, Last_L, VLT_L, RLT_L, 
