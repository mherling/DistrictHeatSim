...
from gui.RenovationTab.SanierungsanalysefuerGUI import calculate_all_results
...
class RenovationTab(QWidget):
    ...
    def run_analysis(self):
        try:
            # Extrahieren der Werte aus den Eingabefeldern
